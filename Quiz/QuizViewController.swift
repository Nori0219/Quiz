...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        quizArray.append(["アニメ「おさるのジョージ」はハンス・アウグストとマーガレットのレイ夫妻による絵本シリーズですが、絵本のタイトルは次のどれでしょうか？", "ものまねこざる", "ものしりこざる", "ひとまねこざる", 3])
        quizArray.append(["おさるのジョージの原作絵本を書いたハンス・アウグストは、どこの国の人でしょうか？", "アメリカ", "ブラジル", "ドイツ", 3])
        quizArray.append(["サル、英語では？", "momky", "monkey", "geoge", 3])
        //------------------------ここから上にクイズを書く------------------------//
